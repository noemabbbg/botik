...
class DataBase:
    ...
    def add_to_storage(self, name, picture, description, number_of_chapters,release_year,manhwa_state):
    ...
    def get_subscription_stats(self):
        ...
        try: 
            ...
            print(error)
'''
    def upload_manhwa(filename, file_id):
        new_collection = db["try1"]
        new_collection.insert_one({f"{filename} : {file_id} "})
'''

...
BASE_MEDIA_PATH = '/Users/f/Desktop/Новая папка 6/uploaded/'


async def uploadMediaFiles(folder, method, file_attr):
    print("ввести название манхвы")
    manhwaname=input()
    ...
    for filename in os.listdir(folder_path):
        ...
        with open(os.path.join(folder_path, filename), 'rb') as file:
            ...
            try:
                ...
                df.upload_manhwa(manhwaname, filename,file_id)
...
'''
изначально бы знать название манхвы (вырежу по названию папки) ->
по названию создаем коллекцию, цепляем по классик словарю 1 : -> etc
